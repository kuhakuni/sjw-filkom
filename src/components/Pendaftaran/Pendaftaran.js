				...
				<div className="container py-16">
					...
					<div className="mb-8">
						...
						<ol className="list-decimal list-outside ml-14 font-semibold text-base md:text-lg lg:text-xl">
							...
							<li className="mb-2">
								Unduh dan isi berkas pendaftaran yang telah
								disediakan.
							</li>
							<li className="mb-2">
								Unggah berkas pendaftaran ke dalam Google Drive
								pribadi (akses Google Drive wajib
								shareable/public). Dengan format folder : Peer
								Counselor_Nama Lengkap_Prodi_Angkatan.pdf kode
								etik bimbingan konseling serta pemahaman
